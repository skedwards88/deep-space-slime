...
export const puzzles = [
  ...
  },
  {
    ...
    winText:
      "At this rate, we'll save humanity from the SLIME in no time!",
    hintText:
  ...
  },
  {
    ...
    winText: "Congrats, you have escaped from the PORTAL STATION. Next up, the SECURITY STATION!",
    hintText:
...
features.terminal2,	features.basic,	features.basic,	features.terminal3,	features.basic,	features.basic,	features.flask,
features.portal,	features.basic,	features.outer,	features.basic,	features.outer,	features.basic,	features.portal,
features.outer,	features.jet,	features.terminal4,	features.portal,	features.terminal1,	features.key,	features.outer,
...
features.outer,	features.flask,	features.basic,	features.door,	features.basic,	features.flask,	features.outer,
features.portal,	features.basic,	features.outer,	features.portal,	features.outer,	features.basic,	features.portal,
features.terminal3,	features.basic,	features.basic,	features.terminal4,	features.basic,	features.basic,	features.terminal2,
features.portal,	features.basic,	features.outer,	features.basic,	features.outer,	features.basic,	features.portal,
features.outer,	features.jet,	features.terminal1,	features.portal,	features.basic,	features.key,	features.outer,
features.outer,	features.outer,	features.basic,	features.start,	features.basic,	features.outer,	features.outer,
features.outer,	features.outer,	features.outer,	features.outer,	features.outer,	features.outer,	features.outer,
    ],
  },
  {
    ...
    puzzle: [
      features.outer,	features.outer,	features.outer,	features.outer,	features.outer,	features.outer,	features.outer,
features.outer,	features.outer,	features.portal,	features.exit,	features.portal,	features.outer,	features.outer,
features.outer,	features.flask,	features.terminal3,	features.door,	features.terminal4,	features.flask,	features.outer,
features.portal,	features.basic,	features.outer,	features.portal,	features.outer,	features.basic,	features.portal,
features.flask,	features.basic,	features.basic,	features.flask,	features.basic,	features.basic,	features.flask,
features.portal,	features.basic,	features.outer,	features.basic,	features.outer,	features.basic,	features.portal,
features.outer,	features.jet,	features.terminal2,	features.portal,	features.terminal1,	features.key,	features.outer,
features.outer,	features.outer,	features.basic,	features.start,	features.basic,	features.outer,	features.outer,
features.outer,	features.outer,	features.outer,	features.outer,	features.outer,	features.outer,	features.outer,
    ],
  },
  {
    ...
    puzzle: [
      features.outer,	features.outer,	features.outer,	features.outer,	features.outer,	features.outer,	features.outer,
features.outer,	features.outer,	features.portal,	features.exit,	features.portal,	features.outer,	features.outer,
features.outer,	features.flask,	features.terminal4,	features.door,	features.terminal2,	features.flask,	features.outer,
features.portal,	features.basic,	features.outer,	features.portal,	features.outer,	features.basic,	features.portal,
features.flask,	features.basic,	features.basic,	features.flask,	features.basic,	features.basic,	features.flask,
features.portal,	features.basic,	features.outer,	features.basic,	features.outer,	features.basic,	features.portal,
features.outer,	features.jet,	features.terminal1,	features.portal,	features.terminal3,	features.key,	features.outer,
features.outer,	features.outer,	features.basic,	features.start,	features.basic,	features.outer,	features.outer,
features.outer,	features.outer,	features.outer,	features.outer,	features.outer,	features.outer,	features.outer,
    ],
  },
