...
export const puzzles = [
  ...
  },
  {
    ...
    puzzle: [
      ...
      'outer',  'outer', 'outer',  'outer',  'outer',
      'outer',  'outer', 'outer',  'outer',  'outer',
      'exit',   'basic', 'portal', 'basic',  'flask',
      'outer',  'outer', 'basic',  '4',      'basic',
      '2',      'basic', 'outer',  'outer',  'portal',
      'basic',  'jet',   'basic',  'portal', 'outer',
      'outer',  'basic', '1',      'basic',  '3',
      'flask',  'outer', 'outer',  'flask',  'basic',
      'portal', 'flask', 'start',  'outer',  'outer',
      'outer',  'outer', 'outer',  'outer',  'outer',
      'outer',  'outer', 'outer',  'outer',  'outer',
      'outer',  'outer', 'outer'
    ],
  ...
  },
  {
    ...
    room: 'Daisy',
    startingText: 'Plants are better than humans. They don’t talk back when you experiment on them.',
    winText: 'Nice job! Let us know what you thought of the game at www.patreon.com/c/skedwards88. We’re still in beta, so all feedback is appreciated!',
    robotStartMood: 'happy',
    robotEndMood: 'happy',
    puzzle: [
      'outer', 'basic',  'flask', 'door',  'flask',
      'basic', 'outer',  'outer', 'key',   'portal',
      'exit',  'portal', 'key',   'outer', 'outer',
      'basic', 'door',   'key',   'door',  'basic',
      'outer', 'outer',  'outer', 'outer', 'basic',
      'outer', 'outer',  'outer', 'outer', 'outer',
      'outer', 'basic',  'flask', 'flask', 'outer',
      'outer', 'flask',  'flask', 'basic', 'flask',
      'flask', 'outer',  'outer', 'flask', 'flask',
      'basic', 'outer',  'outer', 'outer', 'outer',
      'outer', 'outer',  'basic', 'outer', 'outer',
      'outer', 'outer',  'outer', 'outer', 'start',
      'outer', 'outer',  'outer'
    ]
  },
  {
    ...
    puzzle: [
      'outer', 'outer', 'outer', 'outer', 'outer',
      'outer', 'outer', 'outer', 'outer', 'flask',
      'flask', '2',     'outer', 'outer', 'outer',
      'flask', 'flask', 'exit',  'flask', 'flask',
      'outer', 'outer', '3',     'flask', 'flask',
      'flask', 'flask', 'outer', 'outer', 'outer',
      'flask', 'flask', 'flask', 'outer', 'outer',
      'outer', 'outer', 'flask', 'flask', '1',
      'outer', 'outer', 'outer', 'outer', 'flask',
      'outer', 'outer', 'outer', 'outer', 'outer',
      'outer', 'flask', 'outer', 'outer', 'outer',
      'outer', 'outer', 'outer', 'start', 'outer',
      'outer', 'outer', 'outer'
    ]
  },
  {
    ...
    robotEndMood: 'happy',
    puzzle: [
      'outer', 'outer',  'flask', 'flask', 'flask',
      'outer', 'outer',  'outer', 'flask', 'flask',
      'outer', 'flask',  'flask', 'outer', 'outer',
      'flask', 'outer',  'exit',  'outer', 'flask',
      'outer', 'outer',  'flask', 'flask', 'flask',
      'outer', 'flask',  'outer', 'outer', 'outer',
      'outer', 'portal', 'outer', 'flask', 'outer',
      'flask', 'flask',  'flask', 'flask', 'flask',
      'flask', 'portal', 'flask', 'outer', 'flask',
      'flask', 'outer',  'outer', 'flask', 'flask',
      'flask', 'outer',  'flask', 'flask', 'flask',
      'flask', 'outer',  'start', 'outer', 'outer',
      'outer', 'outer',  'outer'
    ]
  },
  {
    ...
    robotEndMood: 'happy',
    puzzle: [
      'basic',  'basic',  'door',  'exit',  'door',
      'key',    'basic',  'key',   'outer', 'basic',
      'door',   'basic',  'outer', 'flask', 'flask',
      'outer',  'outer',  'basic', 'outer', 'outer',
      'portal', 'portal', 'outer', 'outer', 'basic',
      'outer',  'outer',  'outer', 'outer', 'outer',
      'basic',  'basic',  'door',  'flask', 'basic',
      'key',    'basic',  'basic', 'outer', 'flask',
      'portal', 'key',    'flask', 'outer', 'basic',
      'outer',  'portal', 'outer', 'flask', 'portal',
      'outer',  'basic',  'outer', 'outer', 'outer',
      'portal', 'outer',  'outer', 'start', 'outer',
      'outer',  'outer',  'outer'
    ]
  },
  {
    ...
    robotEndMood: 'happy',
    puzzle: [
      'outer',  'outer', 'basic', 'jet',   'basic',
      'outer',  'outer', 'flask', 'basic', 'basic',
      'portal', 'basic', 'basic', 'flask', 'basic',
      'portal', 'flask', 'exit',  'flask', 'portal',
      'basic',  'flask', 'basic', 'basic', 'portal',
      'basic',  'basic', 'flask', 'outer', 'outer',
      'flask',  'basic', 'flask', 'outer', 'outer',
      'outer',  'outer', 'outer', 'flask', 'outer',
      'outer',  'outer', 'outer', 'outer', 'outer',
      'flask',  'outer', 'outer', 'outer', 'outer',
      'outer',  'outer', 'flask', 'outer', 'outer',
      'outer',  'outer', 'outer', 'outer', 'start',
      'outer',  'outer', 'outer'
    ]
  },
  {
    ...
    robotEndMood: 'happy',
    puzzle: [
      'outer',  'outer', 'portal', '4',      'portal',
      'outer',  'outer', 'outer',  'portal', '3',
      'exit',   '5',     'portal', 'outer',  'outer',
      'portal', '1',     'basic',  '2',      'portal',
      'outer',  'outer', 'outer',  'portal', 'flask',
      'portal', 'outer', 'outer',  'outer',  'outer',
      'outer',  'flask', 'outer',  'outer',  'outer',
      'outer',  'outer', 'flask',  'flask',  'jet',
      'outer',  'outer', 'outer',  'outer',  'jet',
      'flask',  'flask', 'outer',  'outer',  'outer',
      'outer',  'flask', 'flask',  'outer',  'outer',
      'outer',  'outer', 'outer',  'outer',  'start',
      'outer',  'outer', 'outer'
  ...
  },
  {
    ...
    puzzle: [
      'outer',  'outer',  'outer', 'outer', 'outer',
      'outer',  'outer',  'outer', 'outer', 'portal',
      'jet',    'portal', 'outer', 'outer', 'outer',
      'portal', 'door',   '1',     'door',  'portal',
      'outer',  'outer',  'outer', '3',     'exit',
      '4',      'outer',  'outer', 'outer', 'key',
      'door',   '2',      'door',  'key',   'outer',
      'outer',  'portal', 'key',   'jet',   'key',
      'portal', 'outer',  'outer', 'outer', 'portal',
      'flask',  'portal', 'outer', 'outer', 'outer',
      'outer',  'outer',  'flask', 'outer', 'outer',
      'outer',  'outer',  'outer', 'outer', 'start',
      'outer',  'outer',  'outer'
  ...
  },
  {
    ...
    robotEndMood: 'happy',
    puzzle: [
      'outer', 'portal', 'outer',  'portal', 'outer',
      'outer', 'outer',  'portal', 'flask',  'jet',
      '3',     'flask',  'outer',  'portal', 'outer',
      '5',     'outer',  'flask',  'portal', 'outer',
      'flask', 'portal', 'jet',    'outer',  'exit',
      'outer', 'portal', 'flask',  'outer',  'flask',
      '1',     'portal', '2',      'flask',  'jet',
      'outer', 'portal', 'flask',  'jet',    'flask',
      '4',     'portal', 'outer',  'outer',  'outer',
      'flask', 'outer',  'outer',  'outer',  'outer',
      'outer', 'outer',  'flask',  'outer',  'outer',
      'outer', 'outer',  'outer',  'outer',  'start',
